...
func NewRequset() *Requset {
	return &Requset{}
}

func (p *Requset) InitDefault() {
}

func (p *Requset) GetMessage() (v string) {
	return p.Message
}
func (p *Requset) SetMessage(val string) {
	p.Message = val
}

var fieldIDToName_Requset = map[int16]string{
	1: "message",
}

func (p *Requset) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_Requset[fieldId]), err)
SkipFieldError:
...
func (p *Requset) ReadField1(iprot thrift.TProtocol) error {
...
func (p *Requset) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("Requset"); err != nil {
...
func (p *Requset) writeField1(oprot thrift.TProtocol) (err error) {
...
func (p *Requset) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("Requset(%+v)", *p)

}

func (p *Requset) DeepEqual(ano *Requset) bool {
	if p == ano {
		return true
...
func (p *Requset) Field1DeepEqual(src string) bool {
...
type Echo interface {
	Echo(ctx context.Context, req *Requset) (r *Response, err error)
}
...
func (p *EchoClient) Echo(ctx context.Context, req *Requset) (r *Response, err error) {
...
type EchoEchoArgs struct {
	Req *Requset `thrift:"req,1" frugal:"1,default,Requset" json:"req"`
}
...
var EchoEchoArgs_Req_DEFAULT *Requset

func (p *EchoEchoArgs) GetReq() (v *Requset) {
	if !p.IsSetReq() {
		return EchoEchoArgs_Req_DEFAULT
	}
	return p.Req
}
func (p *EchoEchoArgs) SetReq(val *Requset) {
	p.Req = val
}
...
func (p *EchoEchoArgs) Field1DeepEqual(src *Requset) bool {
